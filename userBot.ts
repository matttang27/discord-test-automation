...
class UserBot {
   ...
   * @param selector - The CSS selector of the element to find and click.
   */
  async findAndClick(selector: string) {
  ...
  async clickButton(buttonName, message) {
    ...
    await this.page.hover(`#message-accessories-${message.id}`)
    await new Promise((r) => setTimeout(r, 500));
